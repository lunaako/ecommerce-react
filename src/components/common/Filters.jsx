      ...
      <div className="filters-field">
        ...
        {products.length === 0 && isLoading ? (
          ...
          >
            ...
            <option value="fortune">Fortune Crystals</option>
            <option value="midnight">Midnight Aura Jewels</option>
            <option value="lavender">Lavender Dreams</option>
            <option value="clarity">Clarity Gems Co</option>
            <option value="lunaria">Lunaria Crystals</option>
          </select>
        )}
      </div>
      <div className="filters-field">
